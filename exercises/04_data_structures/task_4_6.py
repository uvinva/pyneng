...
next_hop = ospf_route[3].rstrip(',')
last_update = ospf_route[4].rstrip(',')
outband_interface = ospf_route[5]
print(template.format(prefix, ad_metric, next_hop, last_update, outband_interface))